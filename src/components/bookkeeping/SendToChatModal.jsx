...
const SendToChatModal = ({ isOpen, onClose, payment, currency = 'EUR' }) => {
  ...
  const generatePaymentPreview = () => {
    ...
    // Create a beautiful payment card with gradient background like the image
    const statusConfig = {
      completed: {
